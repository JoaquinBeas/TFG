...
class MNISTStudentResNet(nn.Module):
    def __init__(self, 
                 ...
                 timesteps=TIMESTEPS):
        super().__init__()
        # Configuración de parámetros de difusión para sampling
        ...
        # Decoder: Upsample de 7x7 a 28x28
    ...
    def _reverse_diffusion(self, x_t, t, noise):
        # Predicción del ruido usando la red (forward)
    ...
    def sampling(self, n_samples, clipped_reverse_diffusion=True, device="cuda"):
        ...
        x_t = (x_t + 1.0) / 2.0  # Ajuste de rango [-1,1] -> [0,1]
        return x_t
