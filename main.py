...
# Importar los módulos de los scripts (estos archivos deben estar en la carpeta "scripts")
...
def main(model_type):
    ...
    generate_synthetic.generate_synthetic_data()  # Ejecuta generate_synthetic.py
    
    # 3. Etiquetar las imágenes sintéticas
    print("Etiquetando imágenes sintéticas...")
    label_synthetic_data.label_synthetic_data()  # Ejecuta label_synthetic_data.py
